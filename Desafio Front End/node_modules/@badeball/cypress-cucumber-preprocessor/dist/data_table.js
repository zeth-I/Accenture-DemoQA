...
class DataTable {
    constructor(sourceTable) {
        if (sourceTable instanceof Array) {
            ...
            this.rawTable = (0, assertions_1.ensure)(sourceTable.rows, "Expected a PicleTable to have rows").map((row) => (0, assertions_1.ensure)(row.cells, "Expected a PicleTableRow to have cells").map((cell) => {
                const { value } = cell;
