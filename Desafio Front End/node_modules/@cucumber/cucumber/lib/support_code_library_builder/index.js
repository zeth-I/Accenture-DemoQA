...
class SupportCodeLibraryBuilder {
    ...
    defineParameterType(options) {
        ...
        this.parameterTypeRegistry.defineSourcedParameterType(parameterType, source, this.definitionOrder++);
    }
    ...
    buildStepDefinitions(canonicalIds) {
        ...
        this.stepDefinitionConfigs.forEach(({ code, line, options, order, keyword, pattern, uri }, index) => {
            let expression;
